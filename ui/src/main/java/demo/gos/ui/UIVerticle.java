...
public class UIVerticle extends AbstractVerticle {
    ...
    public void start() {
        ...
        router.post("/display").handler(this::displayGameObjectRequestHandler);
        router.post("/displayMore").handler(this::displayGameObjectsRequestHandler);
    ...
    private void displayGameObjectRequestHandler(RoutingContext ctx) {
        ctx.request().bodyHandler(buf -> {
            JsonObject json = buf.toJsonObject();
            ctx.response().end();
            displayGameObject(json);
        });
    }
    ...
    private void displayGameObjectsRequestHandler(RoutingContext ctx) {
        ctx.request().bodyHandler(buf -> {
